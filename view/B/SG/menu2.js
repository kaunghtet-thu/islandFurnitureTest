        ...
        <div id="menuLoggedIn" style="display: none;">\
            <nav>\
                <ul class="nav nav-pills nav-top">\
                    ...
                    <!-- <li>\
                        <a href="/B/' + countryPrefix + '/fav.html"><i class="icon icon-heart"></i>Favourite</a>\
                    </li> -->\
                    <li>\
        ...
        <div class="container">\
            <nav class="nav-main mega-menu">\
                <ul class="nav nav-pills nav-main" id="mainMenu">\
                    ...
                    <li id="fav" style="display: none;">\
                        <a href="/B/' + countryPrefix + '/fav.html"><i class="icon icon-heart"></i> Favourite</a>\
                    </li>\
                    <li>\
                        <a href="/B/' + countryPrefix + '/retailProductsCategory.html?cat=All%20Retail%20Products" + encodeURIComponent("All Retail Products")"><i class="icon icon-coffee"></i> Retail Products</a>\
                    </li>\
                    <li class="dropdown">\
